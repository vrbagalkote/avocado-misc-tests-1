    ...
    def test(self):
        ...
        if not device_list:
            ...
            for device_id in range(len(device_list)):
                device = device_list[device_id].split()[-1].strip("../*")
